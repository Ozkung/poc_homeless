            ...
            return (
              <button
                ...
                style={{
                  ...
                  outline: isSelected ? '2px solid #1677ff' : 'none', outlineOffset: -2,
                  cursor: 'pointer', transition: 'background 0.15s', border: 'none',
                }}
              >
                <span style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', width: 24, height: 24, borderRadius: '50%', marginBottom: 2, fontFamily: "'Sarabun',sans-serif", fontSize: 11, fontWeight: 500, background: isToday ? '#1677ff' : 'transparent', color: isToday ? '#fff' : '#555' }}>
                  {format(day, 'd')}
                </span>
                {dayEvents.length > 0 && (
