  ...
  return (
    <div>
      <div style={{ marginBottom: 20 }}>
        <Link href="/admin/patients" style={{ fontSize: 12, color: '#aaa' }}>← ผู้ป่วย</Link>
      </div>

      <div style={{ marginBottom: 24 }}>
        <div style={{ fontSize: 10, color: '#7c3aed', letterSpacing: 3, textTransform: 'uppercase', marginBottom: 4 }}>
          Patients
        </div>
      ...
      <Card style={{ maxWidth: 640 }}>
        <Form form={form} layout="vertical" onFinish={handleSubmit} initialValues={{ status: 'PENDING' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'flex-end', gap: 12 }}>
            <Button onClick={() => router.push('/admin/patients')}>ยกเลิก</Button>
